...
#cyber_rasta
def cyber_rasta():
	colors = [["#000000", "#000000"],  #background (dark) [0]
			   ["#1a1a1e", "#1a1a1e"],  #background-alt [1]
			   ["#e0e0e0", "#e0e0e0"],  #foreground [2]
			   ["#00e676", "#00e676"],  #secondary/Emerald Green [3]
			   ["#00e676", "#00e676"],  #green [4]
			   ["#4e4e54", "#4e4e54"],  #disabled [5]
			   ["#ffdf00", "#ffdf00"],  #primary/yellow-gold [6]
			   ["#ff3a3a", "#ff3a3a"],  #Neon Red [7]
			   ["#1a1a1e", "#1a1a1e"],  #border [8]
			   ['#ff3a3a', '#ff3a3a'],  #red [9]
			   ["#ffdf00", "#ffdf00"]]  #alert/orange-gold [10]
